StockPlatform.bootstrap(function ($) {
    ...
    function renderSummary(data) {
        ...
        StockPlatform.lineChart(
            'marketChart',
            (data.priceSeries || []).map(function (item) { return item.close; }),
            (data.priceSeries || []).map(function (item) { return item.date; })
        );
    }
    ...
    function fillFormFromRecord(data) {
        ...
        StockPlatform.setValue('marketSource', data.sourceName);
    }
    ...
    async function runQuery() {
        const query = {
            symbol: document.getElementById('marketSymbol').value.trim(),
            ...
            source: document.getElementById('marketSource').value,
