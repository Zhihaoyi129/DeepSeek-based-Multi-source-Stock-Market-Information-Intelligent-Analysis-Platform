StockPlatform.bootstrap(function ($) {
    ...
    const submitButton = document.getElementById('historySubmit');
    ...
    async function load() {
        const data = await StockPlatform.request($, {
            ...
            data: {
                ...
                symbol: StockPlatform.getStockInputValue('historySymbol'),
    ...
    form.addEventListener('submit', function (event) {
        ...
        StockPlatform.withButtonLoading(submitButton, '筛选中...', load).then(function () {
    ...
    StockPlatform.initStockSelector($, 'historySymbol');
